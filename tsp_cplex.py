...
def solve(better, vrp_data):
    ...
    for route in routes:
        ...
        if len(route) > 2: # Optimize routes that have more than 2 cities
...
# vrp_data = [np.array([0., 0., 0., 0.], dtype=float32), np.array([ 1., 19., 37., 52.], dtype=float32), np.array([ 2., 30., 49., 49.], dtype=float32), np.array([ 3., 16., 52., 64.], dtype=float32), np.array([ 4., 23., 31., 62.], dtype=float32), np.array([ 5., 11., 52., 33.], dtype=float32), np.array([ 6., 31., 42., 41.], dtype=float32), np.array([ 7., 15., 52., 41.], dtype=float32), np.array([ 8., 28., 57., 58.], dtype=float32), np.array([ 9.,  8., 62., 42.], dtype=float32), np.array([10.,  8., 42., 57.], dtype=float32), np.array([11.,  7., 27., 68.], dtype=float32), np.array([12., 14., 43., 67.], dtype=float32), np.array([13.,  6., 58., 48.], dtype=float32), np.array([14., 19., 58., 27.], dtype=float32), np.array([15., 11., 37., 69.], dtype=float32)]
